...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/falling-unit-fb64)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/falling-unit-fb64
```

A live public deployment of this template is available at [https://falling-unit-fb64.templates.workers.dev](https://falling-unit-fb64.templates.workers.dev)
